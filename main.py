...
<br>
    ...
    th, td {{
      ...
      <table>
        ...
        <tr>
          ...
          <td>XX°C</td><!--This is where the temperature of the water for the current shower will go-->  
  ...
  slider2.addEventListener("change",(event) => {{updateURL();}})
    ...
    </html>""".format(m_bars_data=m_bars_data,m_text_data = m_text_data, bar_width=bar_width)
    return html
